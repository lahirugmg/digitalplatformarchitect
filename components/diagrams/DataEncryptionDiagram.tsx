export function DataEncryptionDiagram() {
  ...
  return (
    <svg viewBox="0 0 900 700" role="img" aria-labelledby="encryption-title encryption-desc" preserveAspectRatio="xMidYMid meet">
      ...
      <text x="450" y="38" textAnchor="middle" fill={c.text} style={{ font: fontTitle }}>🔐 Data Encryption Patterns</text>
      ...
      <text x="145" y="135" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🏛️ Hardware Security</text>
      <text x="145" y="150" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Module (HSM)</text>

      <rect x="230" y="120" width="110" height="35" fill={c.kms} stroke={c.border} rx="6" ry="6" />
      <text x="285" y="135" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🔄 Key Rotation</text>
      <text x="285" y="150" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Automated</text>

      <rect x="360" y="120" width="130" height="35" fill={c.kms} stroke={c.border} rx="6" ry="6" />
      <text x="425" y="135" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>📦 Envelope Encryption</text>
      <text x="425" y="150" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>DEK + KEK Pattern</text>

      <rect x="510" y="120" width="110" height="35" fill={c.kms} stroke={c.border} rx="6" ry="6" />
      <text x="565" y="135" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🛡️ Key Escrow</text>
      <text x="565" y="150" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Recovery</text>

      <rect x="640" y="120" width="130" height="35" fill={c.kms} stroke={c.border} rx="6" ry="6" />
      <text x="705" y="135" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🔐 Access Control</text>
      <text x="705" y="150" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>RBAC + Policies</text>
      ...
      <text x="120" y="265" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>💻 Client</text>
      <text x="120" y="280" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Browser/App</text>

      <rect x="200" y="245" width="80" height="50" fill={c.transit} stroke={c.border} rx="8" ry="8" />
      <text x="240" y="265" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🌐 Server</text>
      <text x="240" y="280" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>API Gateway</text>

      {/* TLS Connection */}
      <line x1="160" y1="270" x2="200" y2="270" stroke={c.transit} strokeWidth={4} />
      <text x="180" y="265" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>TLS 1.3</text>
      ...
      <text x="720" y="265" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🔢 Homomorphic Encryption</text>
      <text x="720" y="280" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Compute on Encrypted Data</text>

      <rect x="620" y="300" width="200" height="40" fill={c.use} stroke={c.border} rx="8" ry="8" />
      <text x="720" y="320" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🏰 Secure Enclaves (TEE)</text>
      <text x="720" y="335" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Intel SGX, ARM TrustZone</text>
      ...
      <text x="125" y="520" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🇪🇺 GDPR</text>
      <text x="125" y="530" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Data Protection</text>

      <rect x="190" y="500" width="90" height="35" fill="#3498db" stroke={c.border} rx="6" ry="6" />
      <text x="235" y="520" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🏥 HIPAA</text>
      <text x="235" y="530" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Healthcare</text>

      <rect x="300" y="500" width="90" height="35" fill="#f39c12" stroke={c.border} rx="6" ry="6" />
      <text x="345" y="520" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>💳 PCI-DSS</text>
      <text x="345" y="530" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Payment Cards</text>

      <rect x="410" y="500" width="90" height="35" fill="#9b59b6" stroke={c.border} rx="6" ry="6" />
      <text x="455" y="520" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🔒 SOC 2</text>
      <text x="455" y="530" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Security Controls</text>

      <rect x="520" y="500" width="90" height="35" fill="#27ae60" stroke={c.border} rx="6" ry="6" />
      <text x="565" y="520" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🏛️ FedRAMP</text>
      <text x="565" y="530" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Government</text>

      <rect x="630" y="500" width="90" height="35" fill="#e67e22" stroke={c.border} rx="6" ry="6" />
      <text x="675" y="520" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🌍 ISO 27001</text>
      <text x="675" y="530" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Info Security</text>

      <rect x="740" y="500" width="90" height="35" fill="#34495e" stroke={c.border} rx="6" ry="6" />
      <text x="785" y="520" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>🌐 NIST</text>
      <text x="785" y="530" textAnchor="middle" fill={c.subtle} style={{ font: fontSub }}>Cybersecurity</text>
