  ...
  return (
    <svg viewBox="0 0 1600 1400" role="img" aria-labelledby="ai-focus-title ai-focus-desc" preserveAspectRatio="xMidYMid meet">
      ...
      <g>
        ...
        <text x="80" y="306" textAnchor="start" fill={c.subtle} style={{ font: fontMini }}><tspan fontWeight="700">KPIs:</tspan> p99 latency, consumer lag, failover recovery time</text>
      </g>
      ...
      <g>
        ...
        <text x="840" y="306" textAnchor="start" fill={c.subtle} style={{ font: fontMini }}><tspan fontWeight="700">KPIs:</tspan> MTTR, % flows generated by AI, autonomous task success rate</text>
      </g>
      ...
      <g>
        ...
        <text x="80" y="596" textAnchor="start" fill={c.subtle} style={{ font: fontMini }}><tspan fontWeight="700">KPIs:</tspan> Time‑to‑first‑call, APIs discovered via AI, policy violations prevented</text>
      </g>
      ...
      <g>
        ...
        <text x="840" y="580" textAnchor="start" fill={c.subtle} style={{ font: fontMini }}><tspan fontWeight="700">KPIs:</tspan> data freshness SLA, feature reuse rate, RAG accuracy rate</text>
      </g>
      ...
      <g>
        ...
        <text x="80" y="870" textAnchor="start" fill={c.subtle} style={{ font: fontMini }}><tspan fontWeight="700">KPIs:</tspan> lead time for changes, % services via golden paths, cost per inference</text>
      </g>
      ...
      <g>
        ...
        <text x="840" y="870" textAnchor="start" fill={c.subtle} style={{ font: fontMini }}><tspan fontWeight="700">KPIs:</tspan> auth failures avoided, % prompts blocked by policy, consent audit pass rate</text>
      </g>
      ...
      <g>
        ...
        <text x="80" y="1160" textAnchor="start" fill={c.subtle} style={{ font: fontMini }}><tspan fontWeight="700">KPIs:</tspan> MTTR, incidents auto‑remediated, eval pass rate, cost per request</text>
      </g>
    </svg>
  );
}
