...
const PLAYGROUNDS: PlaygroundCard[] = [
  ...
  },
  {
    ...
    description: 'Interactive guide through the 4-step framework for system design interviews, including time allocation.',
    difficulty: 'Beginner',
    duration: '10-15 min',
  ...
  },
  {
    ...
    description: 'Simulate and compare traffic control mechanisms like Token Bucket, Leaking Bucket, and Fixed Window.',
    difficulty: 'Intermediate',
    duration: '15-20 min',
    tags: ['System Design', 'Traffic Control', 'API Gateway'],
    href: '/playgrounds/rate-limiter',
    Icon: ShieldAlert,
  },
  {
    id: 'consistent-hashing',
    title: 'Consistent Hashing Visualizer',
    description: 'Visualize data distribution on a hash ring, dynamic scaling, and virtual nodes for even load balancing.',
    difficulty: 'Advanced',
    duration: '15-20 min',
    tags: ['System Design', 'Load Balancing', 'Algorithms'],
    href: '/playgrounds/consistent-hashing',
    Icon: RefreshCw,
  },
  {
    id: 'key-value-store',
    title: 'Key-Value Store Internals',
    description: 'Explore CAP Theorem tradeoffs, Quorum Consistency tuning, and Vector Clocks for conflict resolution.',
    difficulty: 'Advanced',
    duration: '20-25 min',
    tags: ['System Design', 'Databases', 'Distributed Systems'],
    href: '/playgrounds/key-value-store',
    Icon: Database,
  },
  {
    id: 'unique-id-generator',
    title: 'Unique ID Generator (Snowflake)',
    description: 'Detailed interactive breakdown of the 64-bit Twitter Snowflake algorithm for distributed ID generation.',
    difficulty: 'Intermediate',
    duration: '15-20 min',
    tags: ['System Design', 'Algorithms', 'Distributed Systems'],
    href: '/playgrounds/unique-id-generator',
    Icon: Fingerprint,
  },
]
