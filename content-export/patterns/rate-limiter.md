...
Server-side:
![server-side-rate-limiter](/images/system-design-interview/rate-limiter/server-side-rate-limiter.png)

As a middleware between client and server:
![middleware-rate-limiter](/images/system-design-interview/rate-limiter/middleware-rate-limiter.png)

How it works, assuming 2 requests per second are allowed:
![middleware-rate-limiter-example](/images/system-design-interview/rate-limiter/middleware-rate-limiter-example.png)
...
![token-bucket-algo](/images/system-design-interview/rate-limiter/token-bucket-algo.png)
...
![token-bucket-algo-explained](/images/system-design-interview/rate-limiter/token-bucket-algo-explained.png)
...
![leaking-bucket-algo](/images/system-design-interview/rate-limiter/leaking-bucket-algo.png)
...
![fixed-window-counter-algo](/images/system-design-interview/rate-limiter/fixed-window-counter-algo.png)
...
![traffic-burst-problem](/images/system-design-interview/rate-limiter/traffic-burst-problem.png)
...
![sliding-window-log-algo](/images/system-design-interview/rate-limiter/sliding-window-log-algo.png)
...
![sliding-window-counter-algo](/images/system-design-interview/rate-limiter/sliding-window-counter-algo.png)
...
![high-level-architecture](/images/system-design-interview/rate-limiter/high-level-architecture.png)
...
![lyft-rate-limiting-rules](/images/system-design-interview/rate-limiter/lyft-rate-limiting-rules.png)

Another example \w max login attempts in a minute:
![lyft-rate-limiting-auth-rules](/images/system-design-interview/rate-limiter/lyft-rate-limiting-auth-rules.png)
...
## Detailed design
![detailed-design](/images/system-design-interview/rate-limiter/detailed-design.png)
...
![race-condition](/images/system-design-interview/rate-limiter/race-condition.png)
...
![synchronization-issue](/images/system-design-interview/rate-limiter/synchronization-issue.png)

To solve this issue, we can use a centralized data store (eg Redis) so that the rate limiter instances are stateless.
![redis-centralized-data-store](/images/system-design-interview/rate-limiter/redis-centralized-data-store.png)
