...
![storage-comparison](/images/system-design-interview/s3-like-object-storage/storage-comparison.png)
...
![object-store-vs-unix](/images/system-design-interview/s3-like-object-storage/object-store-vs-unix.png)

By separating metadata from file contents, we can scale the different stores independently:
![bucket-and-object](/images/system-design-interview/s3-like-object-storage/bucket-and-object.png)

## High-level design
![high-level-design](/images/system-design-interview/s3-like-object-storage/high-level-design.png)
...
## Uploading an object
![uploading-object](/images/system-design-interview/s3-like-object-storage/uploading-object.png)
...
![download-object](/images/system-design-interview/s3-like-object-storage/download-object.png)
...
![data-store-interactions](/images/system-design-interview/s3-like-object-storage/data-store-interactions.png)

The data store's main components:
![data-store-main-components](/images/system-design-interview/s3-like-object-storage/data-store-main-components.png)
...
![virtual-cluster-map](/images/system-design-interview/s3-like-object-storage/virtual-cluster-map.png)
...
![data-persistence-flow](/images/system-design-interview/s3-like-object-storage/data-persistence-flow.png)
...
![consistency-vs-latency](/images/system-design-interview/s3-like-object-storage/consistency-vs-latency.png)
...
![wal-optimization](/images/system-design-interview/s3-like-object-storage/wal-optimization.png)
...
![updated-data-persistence-flow](/images/system-design-interview/s3-like-object-storage/updated-data-persistence-flow.png)
...
![failure-domain-isolation](/images/system-design-interview/s3-like-object-storage/failure-domain-isolation.png)
...
![erasure-coding](/images/system-design-interview/s3-like-object-storage/erasure-coding.png)
...
![erasure-coding-across-failure-domains](/images/system-design-interview/s3-like-object-storage/erasure-coding-across-failure-domains.png)
...
![erasure-coding-vs-replication](/images/system-design-interview/s3-like-object-storage/erasure-coding-vs-replication.png)
...
![checksums-for-correctness](/images/system-design-interview/s3-like-object-storage/checksums-for-correctness.png)
...
## Metadata data model
Table schemas:
![metadata-data-model](/images/system-design-interview/s3-like-object-storage/metadata-data-model.png)
...
![object-versioning](/images/system-design-interview/s3-like-object-storage/object-versioning.png)
...
![deleting-versioned-object](/images/system-design-interview/s3-like-object-storage/deleting-versioned-object.png)
...
![multipart-upload](/images/system-design-interview/s3-like-object-storage/multipart-upload.png)
...
![compaction](/images/system-design-interview/s3-like-object-storage/compaction.png)
