...
![hash-ring](/images/system-design-interview/consistent-hashing/hash-ring.png)

# Hash servers
Using the same hash function for the requests, we map the servers based on server IP or name onto the hash ring:
![hash-servers](/images/system-design-interview/consistent-hashing/hash-servers.png)
...
![hash-keys](/images/system-design-interview/consistent-hashing/hash-keys.png)
...
![server-lookup](/images/system-design-interview/consistent-hashing/server-lookup.png)

# Add a server
Via this approach, adding a new server causes only one of the requests to get remapped to a new server:
![add-server-scenario](/images/system-design-interview/consistent-hashing/add-server-scenario.png)

# Remove a server
Likewise, removing a server causes only a single request to get remapped:
![remove-server-scenario](/images/system-design-interview/consistent-hashing/remove-server-scenario.png)

# Two issues in the basic approach
The first problem with this approach is that hash partitions can be uneven across servers:
![hash-partitions](/images/system-design-interview/consistent-hashing/hash-partitions.png)

The second problem derives from the first - it is possible that requests are unevenly distributed across servers:
![uneven-request-distribution](/images/system-design-interview/consistent-hashing/uneven-request-distribution.png)
...
![virtual-nodes](/images/system-design-interview/consistent-hashing/virtual-nodes.png)

Now, a request is mapped to the closest virtual node on the hash ring:
![virtual-node-request-mapping](/images/system-design-interview/consistent-hashing/virtual-node-request-mapping.png)
