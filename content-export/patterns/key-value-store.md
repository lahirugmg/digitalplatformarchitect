...
![cap-theorem](/images/system-design-interview/key-value-store/cap-theorem.png)
...
![example-distributed-system](/images/system-design-interview/key-value-store/example-distributed-system.png)

In the real world, a network partition can occur which hinders communication with eg node 3:
![network-partition-example](/images/system-design-interview/key-value-store/network-partition-example.png)
...
![consistent-hashing](/images/system-design-interview/key-value-store/consistent-hashing.png)
...
![data-replication](/images/system-design-interview/key-value-store/data-replication.png)
...
![write-quorum-example](/images/system-design-interview/key-value-store/write-quorum-example.png)
...
![inconsistency-example](/images/system-design-interview/key-value-store/inconsistency-example.png)
...
![inconsistency-resolution](/images/system-design-interview/key-value-store/inconsistency-resolution.png)
...
![multicasting](/images/system-design-interview/key-value-store/multicasting.png)
...
![gossip-protocol](/images/system-design-interview/key-value-store/gossip-protocol.png)
...
![merkle-tree](/images/system-design-interview/key-value-store/merkle-tree.png)
...
![architecture-diagram](/images/system-design-interview/key-value-store/architecture-diagram.png)
...
![node-responsibilities](/images/system-design-interview/key-value-store/node-responsibilities.png)

## Write path
![write-path](/images/system-design-interview/key-value-store/write-pth.png)
...
![read-path-in-memory](/images/system-design-interview/key-value-store/read-path-in-memory.png)

Read path when data is not in memory:
![read-path-not-in-memory](/images/system-design-interview/key-value-store/read-path-not-in-memory.png)
