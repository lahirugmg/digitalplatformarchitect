...
slug: google-drive
type: system-design
tags: "System Design, Architecture, Cloud Storage"
---
...
![storage-example](/images/system-design-interview/google-drive/storage-example.png)
...
![sharding-example](/images/system-design-interview/google-drive/sharding-example.png)
...
![amazon-s3](/images/system-design-interview/google-drive/amazon-s3.png)
...
![updated-simple-design](/images/system-design-interview/google-drive/updated-simple-design.png)
...
![sync-conflict](/images/system-design-interview/google-drive/sync-conflict.png)
...
![sync-conflict-example](/images/system-design-interview/google-drive/sync-conflict-example.png)

## High-level design
![high-level-design](/images/system-design-interview/google-drive/high-level-design.png)
...
![block-servers-deep-dive](/images/system-design-interview/google-drive/block-servers-deep-dive.png)

Example delta sync:
![delta-sync](/images/system-design-interview/google-drive/delta-sync.png)
...
![metadata-db-deep-dive](/images/system-design-interview/google-drive/metadata-db-deep-dive.png)
...
## Upload flow
![upload-flow](/images/system-design-interview/google-drive/upload-flow.png)
...
![download-flow](/images/system-design-interview/google-drive/download-flow.png)
