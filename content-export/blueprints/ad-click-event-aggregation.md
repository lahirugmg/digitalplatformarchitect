...
type: system-design
tags: "System Design, Architecture, Big Data"
---
...
![digital-advertising-example](/images/system-design-interview/ad-click-event-aggregation/digital-advertising-example.png)
...
![high-level-design-1](/images/system-design-interview/ad-click-event-aggregation/high-level-design-1.png)
...
![high-level-design-2](/images/system-design-interview/ad-click-event-aggregation/high-level-design-2.png)
...
![atomic-commit](/images/system-design-interview/ad-click-event-aggregation/atomic-commit.png)

For the aggregation service, using the MapReduce framework is a good option:
![ad-count-map-reduce](/images/system-design-interview/ad-click-event-aggregation/ad-count-map-reduce.png)
![top-100-map-reduce](/images/system-design-interview/ad-click-event-aggregation/top-100-map-reduce.png)
...
![map-node](/images/system-design-interview/ad-click-event-aggregation/map-node.png)
...
![reduce-node](/images/system-design-interview/ad-click-event-aggregation/reduce-node.png)
...
![use-case-1](/images/system-design-interview/ad-click-event-aggregation/use-case-1.png)
 * Ads are partitioned using `ad_id % 3`

**Use-case 2 - return top N most clicked ads**:
![use-case-2](/images/system-design-interview/ad-click-event-aggregation/use-case-2.png)
...
Lambda architecture:
![lambda-architecture](/images/system-design-interview/ad-click-event-aggregation/lambda-architecture.png)

Kappa architecture:
![kappa-architecture](/images/system-design-interview/ad-click-event-aggregation/kappa-architecture.png)
...
![recalculation-example](/images/system-design-interview/ad-click-event-aggregation/recalculation-example.png)
...
![watermark-technique](/images/system-design-interview/ad-click-event-aggregation/watermark-technique.png)
...
![watermark-2](/images/system-design-interview/ad-click-event-aggregation/watermark-2.png)
...
![tumbling-window](/images/system-design-interview/ad-click-event-aggregation/tumbling-window.png)

As well as a sliding window for the top N clicked ads in M minutes aggregation:
![sliding-window](/images/system-design-interview/ad-click-event-aggregation/sliding-window.png)
...
![data-duplication-example](/images/system-design-interview/ad-click-event-aggregation/data-duplication-example.png)
...
![data-duplication-example-2](/images/system-design-interview/ad-click-event-aggregation/data-duplication-example-2.png)
...
![data-duplication-example-3](/images/system-design-interview/ad-click-event-aggregation/data-duplication-example-3.png)
...
![scale-consumers](/images/system-design-interview/ad-click-event-aggregation/scale-consumers.png)

How do we scale the aggregation service:
![aggregation-service-scaling](/images/system-design-interview/ad-click-event-aggregation/aggregation-service-scaling.png)
...
![multi-threading-example](/images/system-design-interview/ad-click-event-aggregation/multi-threading-example.png)
...
![cassandra-scalability](/images/system-design-interview/ad-click-event-aggregation/cassandra-scalability.png)
...
![hotspot-issue](/images/system-design-interview/ad-click-event-aggregation/hotspot-issue.png)
...
![fault-tolerance-example](/images/system-design-interview/ad-click-event-aggregation/fault-tolerance-example.png)
...
![fault-tolerance-recovery-example](/images/system-design-interview/ad-click-event-aggregation/fault-tolerance-recovery-example.png)
...
![reconciliation-flow](/images/system-design-interview/ad-click-event-aggregation/reconciliation-flow.png)
...
![alternative-design](/images/system-design-interview/ad-click-event-aggregation/alternative-design.png)
