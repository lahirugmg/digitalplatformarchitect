...
slug: google-maps
type: system-design
tags: "System Design, Architecture, LBS"
---
...
![partitioning-system](/images/system-design-interview/google-maps/partitioning-system.png)
...
![map-projections](/images/system-design-interview/google-maps/map-projections.png)
...
![geohashing](/images/system-design-interview/google-maps/geohashing.png)
...
![road-representation](/images/system-design-interview/google-maps/road-representation.png)
...
![routing-tiles](/images/system-design-interview/google-maps/routing-tiles.png)
...
![map-routing-hierarchical](/images/system-design-interview/google-maps/map-routing-hierarchical.png)
...
![high-level-design](/images/system-design-interview/google-maps/high-level-design.png)

## Location service
![location-service](/images/system-design-interview/google-maps/location-service.png)
...
![location-update-batches](/images/system-design-interview/google-maps/location-update-batches.png)
...
![static-map-tiles](/images/system-design-interview/google-maps/static-map-tiles.png)
...
![cdn-vs-no-cdn](/images/system-design-interview/google-maps/cdn-vs-no-cdn.png)
...
![map-tile-url-calculation](/images/system-design-interview/google-maps/map-tile-url-calculation.png)
...
Example row:
![user-location-data-row](/images/system-design-interview/google-maps/user-location-data-torw.png)
...
![precomputed-map-tile-image](/images/system-design-interview/google-maps/precomputed-map-tile-image.png)

## Services
### Location service
Let's focus on the database design and how user location is stored in detail for this service.
![location-service-diagram](/images/system-design-interview/google-maps/location-service-diagram.png)
...
![user-location-row-example](/images/system-design-interview/google-maps/user-location-row-example.png)
...
![location-update-streaming](/images/system-design-interview/google-maps/location-update-streaming.png)
...
![zoom-level-increases](/images/system-design-interview/google-maps/zoom-level-increases.png)
...
![navigation-service](/images/system-design-interview/google-maps/navigation-service.png)
...
![shortest-path-service](/images/system-design-interview/google-maps/shortest-path-service.png)
...
![adaptive-eta-data-storage](/images/system-design-interview/google-maps/adaptive-eta-data-storage.png)
...
![final-design](/images/system-design-interview/google-maps/final-design.png)
