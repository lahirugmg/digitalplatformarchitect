...
slug: digital-wallet
type: system-design
tags: "System Design, Architecture, FinTech"
---
...
![digital-wallet](/images/system-design-interview/digital-wallet/digital-wallet.png)
...
![wallet-service](/images/system-design-interview/digital-wallet/wallet-service.png)
...
![distributed-transactions-relational-dbs](/images/system-design-interview/digital-wallet/distributed-transactions-relational-dbs.png)

Here's how the two-phase commit (2PC) protocol works:
![2pc-protocol](/images/system-design-interview/digital-wallet/2pc-protocol.png)
...
Phase 1 - try:
![try-phase](/images/system-design-interview/digital-wallet/try-phase.png)
...
Phase 2a - confirm:
![confirm-phase](/images/system-design-interview/digital-wallet/confirm-phase.png)
...
Phase 2b - cancel:
![cancel-phase](/images/system-design-interview/digital-wallet/cancel-phase.png)
...
![phase-status-tables](/images/system-design-interview/digital-wallet/phase-status-tables.png)
...
![unbalanced-state](/images/system-design-interview/digital-wallet/unbalanced-state.png)
...
![out-of-order-execution](/images/system-design-interview/digital-wallet/out-of-order-execution.png)
...
![saga](/images/system-design-interview/digital-wallet/saga.png)
...
![event-sourcing](/images/system-design-interview/digital-wallet/event-sourcing.png)

Here's a dynamic view of event sourcing:
![dynamic-event-sourcing](/images/system-design-interview/digital-wallet/dynamic-event-sourcing.png)

For our wallet service, the commands are balance transfer requests. We can put them in a FIFO queue, such as Kafka:
![command-queue](/images/system-design-interview/digital-wallet/command-queue.png)

Here's the full picture:
![wallet-service-state-machine](/images/system-design-interview/digital-wallet/wallet-service-state-macghine.png)
...
![historical-states](/images/system-design-interview/digital-wallet/historical-states.png)
...
![cqrs-architecture](/images/system-design-interview/digital-wallet/cqrs-architecture.png)
...
![mmap-optimization](/images/system-design-interview/digital-wallet/mmap-optimization.png)
...
![rocks-db-approach](/images/system-design-interview/digital-wallet/rocks-db-approach.png)
...
![snapshot-approach](/images/system-design-interview/digital-wallet/snapshot-approach.png)
...
![raft-replication](/images/system-design-interview/digital-wallet/raft-replication.png)
...
![polling-approach](/images/system-design-interview/digital-wallet/polling-approach.png)
...
![reverse-proxy](/images/system-design-interview/digital-wallet/reverse-proxy.png)
...
![push-state-machines](/images/system-design-interview/digital-wallet/push-state-machines.png)
...
![sharded-raft-groups](/images/system-design-interview/digital-wallet/sharded-raft-groups.png)
