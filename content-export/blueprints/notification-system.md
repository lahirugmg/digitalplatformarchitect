...
![ios-push-notifications](/images/system-design-interview/notification-system/ios-push-notifications.png)
...
![android-push-notifications](/images/system-design-interview/notification-system/android-push-notifications.png)

### SMS Message
For SMS, third-party providers like Twilio are available:
![sms-messages](/images/system-design-interview/notification-system/sms-messages.png)

### Email
Although clients can setup their own mail servers, most clients opt-in to use third-party services, like Mailchimp:
![email-sending](/images/system-design-interview/notification-system/email-sending.png)

Here's final design after including all notification providers:
![notification-providers-design](/images/system-design-interview/notification-system/notification-providers-design.png)
...
![contact-info-gathering](/images/system-design-interview/notification-system/contact-info-gathering.png)

Example database tables for storing contact info:
![contact-info-db](/images/system-design-interview/notification-system/contact-info-db.png)

## Notification sending/receiving flow
Here's the high-level design of our notification system:
![high-level-design](/images/system-design-interview/notification-system/high-level-design.png)
...
![high-level-design-improved](/images/system-design-interview/notification-system/high-level-design-improved.png)
...
![notification-log-db](/images/system-design-interview/notification-system/notification-log-db.png)
...
![notifications-queue](/images/system-design-interview/notification-system/notifications-queue.png)
...
![notification-events](/images/system-design-interview/notification-system/notification-events.png)

## Updated design
Putting everything together, here's our final design:
![final-design](/images/system-design-interview/notification-system/final-design.png)
