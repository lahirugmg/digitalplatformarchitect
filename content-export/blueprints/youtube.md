...
slug: youtube
type: system-design
tags: "System Design, Architecture, Video Streaming"
---
...
![high-level-sys-design](/images/system-design-interview/youtube/high-level-sys-design.png)
...
![video-uploading-flow](/images/system-design-interview/youtube/video-uploading-flow.png)
...
![metadata-update-flow](/images/system-design-interview/youtube/metadata-update-flow.png)
...
![video-streaming-flow](/images/system-design-interview/youtube/video-streaming-flow.png)
...
![dag-model](/images/system-design-interview/youtube/dag-model.png)
...
![video-encodings](/images/system-design-interview/youtube/video-encodings.png)

## Video transcoding architecture
![video-transcoding-architecture](/images/system-design-interview/youtube/video-transcoding-architecture.png)

### Preprocessor
![preprocessor](/images/system-design-interview/youtube/preprocessor.png)
...
![dag-config-example](/images/system-design-interview/youtube/dag-config-example.png)

### DAG Scheduler
![dag-scheduler](/images/system-design-interview/youtube/dag-scheduler.png)

DAG scheduler splits a DAG into stages of tasks and puts them in a task queue, managed by a resource manager:
![dag-split-example](/images/system-design-interview/youtube/dag-split-example.png)

In this example, a video is split into video, audio and metadata stages which are processed in parallel.

### Resource manager
![resource-manager](/images/system-design-interview/youtube/resource-manager.png)

Resource manager is responsible for optimizing resource allocation.
![resource-manager-deep-dive](/images/system-design-interview/youtube/resource-manager-deep-dive.png)
...
### Task workers
![task-workers](/images/system-design-interview/youtube/task-workers.png)
...
![task-workers-example](/images/system-design-interview/youtube/task-workers-example.png)

### Temporary storage
![temporary-storage](/images/system-design-interview/youtube/temporary-storage.png)
...
### Encoded video
![encoded-video](/images/system-design-interview/youtube/encoded-video.png)
...
![video-uploading-optimization](/images/system-design-interview/youtube/video-uploading-optimization.png)

This enables fast resumable uploads if something goes wrong. Splitting the video file is done by the client.

### Speed optimization - place upload centers close to users
![upload-centers](/images/system-design-interview/youtube/upload-centers.png)
...
![no-parralelism-components](/images/system-design-interview/youtube/no-parralelism-components.png)
...
![parralelism-components](/images/system-design-interview/youtube/parralelism-components.png)

### Safety optimization - pre-signed upload URL
To avoid unauthorized users from uploading videos, we introduce pre-signed upload URLs:
![presigned-upload-url](/images/system-design-interview/youtube/presigned-upload-url.png)
...
![cdn-optimization](/images/system-design-interview/youtube/cdn-optimization.png)
