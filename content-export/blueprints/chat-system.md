...
![store-relay-message](/images/system-design-interview/chat-system/store-relay-message.png)
...
![polling](/images/system-design-interview/chat-system/polling.png)

This is easy to implement but it can be costly as there are many requests, which often yield no results

## Long polling
![long-polling](/images/system-design-interview/chat-system/long-polling.png)
...
![web-sockets](/images/system-design-interview/chat-system/web-sockets.png)
...
![high-level-design](/images/system-design-interview/chat-system/high-level-design.png)
...
![refined-high-level-design](/images/system-design-interview/chat-system/refined-high-level-design.png)
...
![one-on-one-chat-table](/images/system-design-interview/chat-system/one-on-one-chat-table.png)
...
![group-chat-table](/images/system-design-interview/chat-system/group-chat-table.png)
...
![service-discovery](/images/system-design-interview/chat-system/service-discovery.png)
...
### 1 on 1 chat flow
![one-on-one-chat-flow](/images/system-design-interview/chat-system/one-on-one-chat-flow.png)
...
![message-sync](/images/system-design-interview/chat-system/message-sync.png)
...
![group-chat-flow](/images/system-design-interview/chat-system/group-chat-flow.png)
...
![recipient-group-chat](/images/system-design-interview/chat-system/recipient-group-chat.png)
...
![user-login-online](/images/system-design-interview/chat-system/user-login-online.png)
...
![user-logout-offline](/images/system-design-interview/chat-system/user-logout-offline.png)
...
![user-heartbeat](/images/system-design-interview/chat-system/user-heartbeat.png)
...
![presence-status-fanout](/images/system-design-interview/chat-system/presence-status-fanout.png)
