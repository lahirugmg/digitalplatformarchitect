...
![web-crawler-example](/images/system-design-interview/web-crawler/web-crawler-example.png)
...
![high-level-design](/images/system-design-interview/web-crawler/high-level-design.png)
...
![web-crawler-workflow](/images/system-design-interview/web-crawler/web-crawler-workflow.png)
...
![download-queue](/images/system-design-interview/web-crawler/download-queue.png)
 * The queue router ensures that each queue contains URLs from the same host.
 * Mapping table - maps each host to a queue.
![mapping-table](/images/system-design-interview/web-crawler/mapping-table.png)
...
![prioritizer](/images/system-design-interview/web-crawler/prioritizer.png)
...
![distributed-crawl](/images/system-design-interview/web-crawler/distributed-crawl.png)
...
![extendable-crawler](/images/system-design-interview/web-crawler/extendable-crawler.png)
