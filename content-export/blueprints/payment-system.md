...
![high-level-flow](/images/system-design-interview/payment-system/high-level-flow.png)

## Pay-in flow
Here's the high-level overview of the pay-in flow:
![pay-in-flow-high-level](/images/system-design-interview/payment-system/payin-flow-high-level.png)
...
![hosted-payment-page](/images/system-design-interview/payment-system/hosted-payment-page.png)
...
![hosted-payment-page-workflow](/images/system-design-interview/payment-system/hosted-payment-page-workflow.png)
...
![settlement-report](/images/system-design-interview/payment-system/settlement-report.png)
...
![single-receiver](/images/system-design-interview/payment-system/single-receiver.png)

Multiple receivers - multiple receivers subscribe to the same topic, but messages are forwarded to all of them:
![multiple-receiver](/images/system-design-interview/payment-system/multiple-receiver.png)
...
![failed-payments](/images/system-design-interview/payment-system/failed-payments.png)
...
![retry-mechanism](/images/system-design-interview/payment-system/retry-mechanism.png)
...
![idempotency-example](/images/system-design-interview/payment-system/idempotency-example.png)
