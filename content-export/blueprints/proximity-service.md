...
![business-table](/images/system-design-interview/proximity-service/business-table.png)
...
![high-level-design](/images/system-design-interview/proximity-service/high-level-deisgn.png)
...
![2d-search](/images/system-design-interview/proximity-service/2d-search.png)
...
![2d-query-problem](/images/system-design-interview/proximity-service/2d-query-problem.png)

We can, however, build 2D indexes and there are different approaches to that:
![2d-index-options](/images/system-design-interview/proximity-service/2d-index-options.png)
...
![evenly-divided-grid](/images/system-design-interview/proximity-service/evenly-divided-grid.png)
...
![geohash-example](/images/system-design-interview/proximity-service/geohash-example.png)
...
![geohash-precision](/images/system-design-interview/proximity-service/geohash-precision.png)

Geohashes enable us to quickly locate neighboring regions based on a substring of the geohash:
![geohash-substring](/images/system-design-interview/proximity-service/geohash-substrint.png)
...
![boundary-issue-geohash](/images/system-design-interview/proximity-service/boundary-issue-geohash.png)
...
![geohash-boundary-issue-2](/images/system-design-interview/proximity-service/geohash-boundary-issue-2.png)
...
![geohash-expansion](/images/system-design-interview/proximity-service/geohash-expansion.png)
...
![quadtree-example](/images/system-design-interview/proximity-service/quadtree-example.png)

This is an in-memory solution which can't easily be implemented in a database.

Here's how it might look conceptually:
![quadtree-concept](/images/system-design-interview/proximity-service/quadtree-concept.png)
...
![denver-quadtree](/images/system-design-interview/proximity-service/denver-quadtree.png)
...
![hilbert-curve](/images/system-design-interview/proximity-service/hilbert-curbe.png)

This library is great for geofencing, which supports covering arbitrary areas vs. confining yourself to specific quadrants.
![geofence-example](/images/system-design-interview/proximity-service/geofence-example.png)
...
![company-adoptions](/images/system-design-interview/proximity-service/company-adoptions.png)
...
![geohash-table-example](/images/system-design-interview/proximity-service/geohash-table-example.png)
...
![cross-dc-deployment](/images/system-design-interview/proximity-service/cross-dc-deployment.png)
...
![final-design](/images/system-design-interview/proximity-service/final-design.png)
