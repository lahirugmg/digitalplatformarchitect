...
type: system-design
tags: "System Design, Architecture, Email"
---
...
![dns-lookup](/images/system-design-interview/distributed-email-service/dns-lookup.png)
...
![traditional-mail-server](/images/system-design-interview/distributed-email-service/traditional-mail-server.png)
...
![local-dir-storage](/images/system-design-interview/distributed-email-service/local-dir-storage.png)
...
![high-level-architecture](/images/system-design-interview/distributed-email-service/high-level-architecture.png)
...
![email-sending-flow](/images/system-design-interview/distributed-email-service/email-sending-flow.png)
...
![email-receiving-flow](/images/system-design-interview/distributed-email-service/email-receiving-flkow.png)
...
![legend](/images/system-design-interview/distributed-email-service/legend.png)

Here is the folders table:
![folders-table](/images/system-design-interview/distributed-email-service/folders-table.png)

emails table:
![emails-table](/images/system-design-interview/distributed-email-service/emails-table.png)
...
![attachments](/images/system-design-interview/distributed-email-service/attachments.png)
...
![read-unread-emails](/images/system-design-interview/distributed-email-service/read-unread-emails.png)
...
![elasticsearch](/images/system-design-interview/distributed-email-service/elasticsearch.png)
...
![lsm-tree](/images/system-design-interview/distributed-email-service/lsm-tree.png)
...
![multi-dc-example](/images/system-design-interview/distributed-email-service/multi-dc-example.png)
