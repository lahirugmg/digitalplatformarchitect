...
![google-search](/images/system-design-interview/search-autocomplete-system/google-search.png)
...
![frequency-table](/images/system-design-interview/search-autocomplete-system/frequency-table.png)
...
![query-service-example](/images/system-design-interview/search-autocomplete-system/query-service-example.png)

Querying the data set is a matter of running the following SQL query:
![query-service-sql-query](/images/system-design-interview/search-autocomplete-system/query-service-sql-query.png)
...
![trie-example-with-frequency](/images/system-design-interview/search-autocomplete-system/trie-example-with-frequency.png)
...
![trie-algorithm](/images/system-design-interview/search-autocomplete-system/trie-algorithm.png)
...
![caching-top-search-results](/images/system-design-interview/search-autocomplete-system/caching-top-search-results.png)
...
![data-gathering-service](/images/system-design-interview/search-autocomplete-system/data-gathering-service.png)

The analytics logs contain raw rows of data related to search terms \w timestamps:
![analytics-log](/images/system-design-interview/search-autocomplete-system/analytics-log.png)
...
![weekly-aggredated-data](/images/system-design-interview/search-autocomplete-system/weekly-aggredated-data.png)
...
![trie-as-hashmap](/images/system-design-interview/search-autocomplete-system/trie-as-hashmap.png)

## Query service
The query service fetches top suggestions from Trie Cache or fallbacks to Trie DB on cache miss:
![query-service-improved](/images/system-design-interview/search-autocomplete-system/query-service-improved.png)
...
![google-browser-caching](/images/system-design-interview/search-autocomplete-system/google-browser-caching.png)
...
![update-trie](/images/system-design-interview/search-autocomplete-system/update-trie.png)
...
![filter-layer](/images/system-design-interview/search-autocomplete-system/filter-layer.png)
...
![sharding](/images/system-design-interview/search-autocomplete-system/sharding.png)
