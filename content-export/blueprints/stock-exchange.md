...
![world-stock-exchanges](/images/system-design-interview/stock-exchange/world-stock-exchanges.png)
...
![l1-price](/images/system-design-interview/stock-exchange/l1-price.png)

L2 includes more price levels:
![l2-price](/images/system-design-interview/stock-exchange/l2-price.png)

L3 shows levels and queued quantity at each level:
![l3-price](/images/system-design-interview/stock-exchange/l3-price.png)

A candlestick shows the market open and close price, as well as the highest and lowest prices in the given interval:
![candlestick](/images/system-design-interview/stock-exchange/candlestick.png)
...
## High-level design
![high-level-design](/images/system-design-interview/stock-exchange/high-level-design.png)
...
![sequencer](/images/system-design-interview/stock-exchange/sequencer.png)
...
![client-gateway](/images/system-design-interview/stock-exchange/client-gateway.png)
...
![client-gateways](/images/system-design-interview/stock-exchange/client-gateways.png)
...
![market-data](/images/system-design-interview/stock-exchange/market-data.png)

### Reporting flow
The reporter is not on the critical path, but it is an important component nevertheless.
![reporting-flow](/images/system-design-interview/stock-exchange/reporting-flow.png)
...
![product-order-execution-data-model](/images/system-design-interview/stock-exchange/product-order-execution-data-model.png)
...
![order-book-execution](/images/system-design-interview/stock-exchange/order-book-execution.png)
...
![order-book-impl](/images/system-design-interview/stock-exchange/order-book-impl.png)
...
![mmap-bus](/images/system-design-interview/stock-exchange/mmap-bus.png)
...
![application-loop](/images/system-design-interview/stock-exchange/application-loop.png)
...
![event-sourcing](/images/system-design-interview/stock-exchange/event-sourcing.png)
 * On the left - traditional schema
 * On the right - event source schema

Here's how our design looks like thus far:
![design-so-far](/images/system-design-interview/stock-exchange/design-so-far.png)
...
![sequencer-deep-dive](/images/system-design-interview/stock-exchange/sequencer-deep-dive.png)
...
![leader-election](/images/system-design-interview/stock-exchange/leader-election.png)
...
![replication-across-servers](/images/system-design-interview/stock-exchange/replication-across-servers.png)

Example leader-election terms:
![leader-election-terms](/images/system-design-interview/stock-exchange/leader-election-terms.png)
...
![determinism](/images/system-design-interview/stock-exchange/determinism.png)
...
![market-data-publisher](/images/system-design-interview/stock-exchange/market-data-publisher.png)
