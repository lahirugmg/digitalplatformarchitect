...
type: system-design
tags: "System Design, Architecture, Booking"
---
...
![qps-estimation](/images/system-design-interview/hotel-reservation-system/qps-estimation.png)
...
![schema-design](/images/system-design-interview/hotel-reservation-system/schema-design.png)
...
![status-state-machine](/images/system-design-interview/hotel-reservation-system/status-state-machine.png)
...
![high-level-design](/images/system-design-interview/hotel-reservation-system/high-level-design.png)
...
![updated-schema](/images/system-design-interview/hotel-reservation-system/updated-schema.png)
...
![double-booking-single-user](/images/system-design-interview/hotel-reservation-system/double-booking-single-user.png)
...
![idempotency](/images/system-design-interview/hotel-reservation-system/idempotency.png)
...
![unique-constraint-violation](/images/system-design-interview/hotel-reservation-system/unique-constraint-violation.png)

What if there are multiple users making the same reservation?
![double-booking-multiple-users](/images/system-design-interview/hotel-reservation-system/double-booking-multiple-users.png)
...
![pessimistic-locking](/images/system-design-interview/hotel-reservation-system/pessimistic-locking.png)
...
![optimistic-locking](/images/system-design-interview/hotel-reservation-system/optimistic-locking.png)
...
```
![database-constraint](/images/system-design-interview/hotel-reservation-system/database-constraint.png)
...
![database-sharding](/images/system-design-interview/hotel-reservation-system/database-sharding.png)
...
![inventory-cache](/images/system-design-interview/hotel-reservation-system/inventory-cache.png)
...
![microservices-vs-monolith](/images/system-design-interview/hotel-reservation-system/microservices-vs-monolith.png)
...
![atomicity-monolith](/images/system-design-interview/hotel-reservation-system/atomicity-monolith.png)

It's more challenging, however, to guarantee this atomicity when the operation spans across multiple services:
![microservice-non-atomic-operation](/images/system-design-interview/hotel-reservation-system/microservice-non-atomic-operation.png)
