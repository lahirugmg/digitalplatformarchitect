...
![fan-out-backend](/images/system-design-interview/nearby-friends/fan-out-backend.png)
...
![simple-high-level-design](/images/system-design-interview/nearby-friends/simple-high-level-design.png)
...
![redis-pubsub-usage](/images/system-design-interview/nearby-friends/redis-pubsub-usage.png)
...
![periodic-location-update](/images/system-design-interview/nearby-friends/periodic-location-update.png)
...
![detailed-periodic-location-update](/images/system-design-interview/nearby-friends/detailed-periodic-location-update.png)
...
![channel-distribution-data](/images/system-design-interview/nearby-friends/channel-distribution-data.png)
...
![consistent-hashing](/images/system-design-interview/nearby-friends/consistent-hashing.png)
...
![geohash-pubsub](/images/system-design-interview/nearby-friends/geohash-pubsub.png)

Anyone within the geohash subscribes to the appropriate channel to receive location updates for random users:
![location-updates-geohash](/images/system-design-interview/nearby-friends/location-updates-geohash.png)

We could also subscribe to several geohashes to handle cases where someone is close but in a bordering geohash:
![geohash-borders](/images/system-design-interview/nearby-friends/geohash-borders.png)
