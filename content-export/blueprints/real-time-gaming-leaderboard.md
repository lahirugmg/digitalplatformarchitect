...
type: system-design
tags: "System Design, Architecture, Gaming"
---

We are going to design a leaderboard for an online mobile game:
![leaderboard](/images/system-design-interview/real-time-gaming-leaderboard/leaderboard.png)
...
![high-level-architecture](/images/system-design-interview/real-time-gaming-leaderboard/high-level-architecture.png)
...
![alternative-design](/images/system-design-interview/real-time-gaming-leaderboard/alternative-design.png)
...
![message-queue-based-comm](/images/system-design-interview/real-time-gaming-leaderboard/message-queue-based-comm.png)
...
![leaderboard-table](/images/system-design-interview/real-time-gaming-leaderboard/leaderboard-table.png)
...
![user-wins-point](/images/system-design-interview/real-time-gaming-leaderboard/user-wins-point.png)
...
![find-leaderboard-position](/images/system-design-interview/real-time-gaming-leaderboard/find-leaderboard-position.png)
...
![sorted-set](/images/system-design-interview/real-time-gaming-leaderboard/sorted-set.png)
...
![skip-list](/images/system-design-interview/real-time-gaming-leaderboard/skip-list.png)
...
![skip-list-performance](/images/system-design-interview/real-time-gaming-leaderboard/skip-list-performance.png)
...
![leaderboard-position-of-user](/images/system-design-interview/real-time-gaming-leaderboard/leaderboard-position-of-user.png)
...
![manage-services-ourselves](/images/system-design-interview/real-time-gaming-leaderboard/manage-services-ourselves.png)
...
![api-gateway-mapping](/images/system-design-interview/real-time-gaming-leaderboard/api-gateway-mapping.png)
...
![user-scoring-point-lambda](/images/system-design-interview/real-time-gaming-leaderboard/user-scoring-point-lambda.png)

Example user retrieving leaderboard:
![user-retrieve-leaderboard](/images/system-design-interview/real-time-gaming-leaderboard/user-retrieve-leaderboard.png)
...
![range-partition](/images/system-design-interview/real-time-gaming-leaderboard/range-partition.png)
...
![hash-partition](/images/system-design-interview/real-time-gaming-leaderboard/hash-partition.png)
...
![top-10-players-calculation](/images/system-design-interview/real-time-gaming-leaderboard/top-10-players-calculation.png)
...
![dynamo-db](/images/system-design-interview/real-time-gaming-leaderboard/dynamo-db.png)

Let's start from a table for storing a leaderboard for a chess game:
![chess-game-leaderboard-table-1](/images/system-design-interview/real-time-gaming-leaderboard/chess-game-leaderboard-table-1.png)

This works well, but doesn't scale well if we need to query anything by score. Hence, we can put the score as a sort key:
![chess-game-leaderboard-table-2](/images/system-design-interview/real-time-gaming-leaderboard/chess-game-leaderboard-table-2.png)
...
![chess-game-leaderboard-table-3](/images/system-design-interview/real-time-gaming-leaderboard/chess-game-leaderboard-table-3.png)
...
![scatter-gather-2](/images/system-design-interview/real-time-gaming-leaderboard/scatter-gather-2.png)
