...
slug: metrics-monitoring-alerting-system
type: system-design
tags: "System Design, Architecture, Observability"
---
...
![metrics-monitoring-core-components](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-monitoring-core-components.png)
...
![metrics-example-1](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-example-1.png)

The data can be identified by the following table:
![metrics-example-1-data](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-example-1-data.png)
...
![time-series-data-example](/images/system-design-interview/metrics-monitoring-alerting-system/time-series-data-example.png)

A good way to visualize how data looks like:
![time-series-data-viz](/images/system-design-interview/metrics-monitoring-alerting-system/time-series-data-viz.png)
...
![influxdb-scale](/images/system-design-interview/metrics-monitoring-alerting-system/influxdb-scale.png)
...
## High-level Design
![high-level-design](/images/system-design-interview/metrics-monitoring-alerting-system/high-level-design.png)
...
![metrics-collection](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-collection.png)

There are two ways to implement metrics collection - pull or push.

Here's how the pull model might look like:
![pull-model-example](/images/system-design-interview/metrics-monitoring-alerting-system/pull-model-example.png)
...
![service-discovery-example](/images/system-design-interview/metrics-monitoring-alerting-system/service-discovery-example.png)

Here's a detailed explanation of the metrics collection flow:
![metrics-collection-flow](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-collection-flow.png)
...
![consistent-hash-ring](/images/system-design-interview/metrics-monitoring-alerting-system/consistent-hash-ring.png)

With the push model, on the other hand, services push their metrics to the metrics collector proactively:
![push-model-example](/images/system-design-interview/metrics-monitoring-alerting-system/push-model-example.png)
...
![metrics-collector-agent](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-collector-agent.png)
...
![metrics-transmission-pipeline](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-transmission-pipeline.png)
...
![queuing-mechanism](/images/system-design-interview/metrics-monitoring-alerting-system/queuing-mechanism.png)
...
![metrics-collection-kafka](/images/system-design-interview/metrics-monitoring-alerting-system/metrics-collection-kafka.png)
...
![cache-layer-query-service](/images/system-design-interview/metrics-monitoring-alerting-system/cache-layer-query-service.png)
...
![double-delta-encoding](/images/system-design-interview/metrics-monitoring-alerting-system/double-delta-encoding.png)
...
## Alerting system
![alerting-system](/images/system-design-interview/metrics-monitoring-alerting-system/alerting-system.png)
...
![grafana-dashboard](/images/system-design-interview/metrics-monitoring-alerting-system/grafana-dashboard.png)
...
![final-design](/images/system-design-interview/metrics-monitoring-alerting-system/final-design.png)
